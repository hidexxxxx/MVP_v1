    ...
    <body class="antialiased">
        <header class="text-gray-600 body-font mb-4">
            <div class="container mx-auto flex flex-wraxp p-5 flex-col md:flex-row items-center">
                <img src="images/LeapCompass.png" class="p-2 hover:cursor-pointer" alt="Logo" style="width:15%; height:auto;" onclick="window.location.href = '/UserProfile'">
            </div>
        </header>
                ...
                <div class="container px-5 py-24 mx-auto">
                    ...
                    <div class="md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
                        ...
                        <p class="leading-relaxed text-base mb-4">本規約では、以下の用語は以下の意味で利用するものとします。</p>
                            <li>
                            「本サービス」とは、運営側（以下、第２号で定義）が利用者に対して提供するコミュニティ内のユーザー同士でメンタリングを行うサービスである「Leap Compass 360」をいいます。
                            </li>
                            <li>
            ...
            <div class="container px-5 py-8 mx-auto flex flex-col sm:flex-row justify-center items-center">
                ...
                <div class="flex flex-col sm:flex-row items-center">
                    ...
                    <a href="/TermsConditions.html" class="sm:ml-4">
                        <button class="inline-flex items-center font-light text-gray-500 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-sm tracking-tighter">利用規約</button>
                    </a>
                    <a href="/PrivacyPolicy.html" class="sm:ml-4">
                        <button class="inline-flex items-center font-light text-gray-500 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-sm tracking-tighter">プライバシーポリシー</button>
                    </a>
                    <a href="/OurTeam.html" class="sm:ml-4">
                        <button class="inline-flex items-center font-light text-gray-500 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-sm tracking-tighter">About Us</button>
                    </a>
                </div>
            </div>
        </footer>
