                ...
                <div class="container px-5 py-24 mx-auto">
                    <div class="flex flex-col text-center w-full mb-20">
                        ...
                        <p class="lg:w-2/3 mx-auto leading-relaxed text-lg mt-6" >
                            G'sコミュニティーには素敵な知識や経験を持った方が多くいますが、
                            <br>
                            誰がどんなバックグラウンドを持っているのか分かれば
                            <br>
                            更に知見やスキルをシェアし合うことができ、
                            <br>
                            各々の理想に一歩でも近づくことができるのではないかと思い
                            <br>
                            Leap Compass 360を作りました。
                            <br>
                            Leap Compass 360を使い
                            <br>
                            皆さんの理想を形にできる支援ができれば幸いです。
                        </p>
                    </div>
                            ...
                            <!-- <img alt="team" class="flex-shrink-0 rounded-lg w-full h-65 object-cover object-center mb-4" src="images/hidexxxxx.jpg"> -->
                                <div class="w-full">
                                    ...
                                    <p class="leading-relaxed text-base mb-8 mt-8">
                                        ...
                                        その後、G's ACCADEMYのLABコースに入学し、人々の働き方改善を支援できるサービス開発を目指しています。
                                    </p>
                                </div>
                            </div>
                        </div>
